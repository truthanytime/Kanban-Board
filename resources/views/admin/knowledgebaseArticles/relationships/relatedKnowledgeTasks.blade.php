...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-relatedKnowledgeTasks">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($tasks as $key => $task)
                        <tr data-entry-id="{{ $task->id }}">
                            ...
                            <td>
                                @foreach($task->features as $key => $item)
                                    <span class="badge badge-info">{{ $item->status }}</span>
                                @endforeach
                            </td>
                            <td>
                                @foreach($task->related_knowledges as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-relatedKnowledgeTasks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
